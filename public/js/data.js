...
window.PMP_DATA = {
  ...
  /* ---------------------------------------------------------------
     ABBREVIATIONS / ACRONYMS  {abbr, full, note, tier}
     tier 1 = must know cold, 2 = high value, 3 = good to know
     --------------------------------------------------------------- */
  abbreviations: [
    /* ---- Tier 1: must know cold ---- */
    { tier: 1, abbr: "PMI", full: "Project Management Institute", note: "The body that owns the PMP credential, the PMBOK Guide, and the Code of Ethics." },
    { tier: 1, abbr: "PMP", full: "Project Management Professional", note: "The certification you're sitting for." },
    { tier: 1, abbr: "PMBOK", full: "Project Management Body of Knowledge", note: "PMI's reference standard. The exam tests judgment, not the book verbatim." },
    { tier: 1, abbr: "ECO", full: "Examination Content Outline", note: "The exam blueprint: People 42% · Process 50% · Business Environment 8%. ~half is agile/hybrid." },
    { tier: 1, abbr: "PM", full: "Project Manager", note: "On the exam, a servant leader — facilitates and removes blockers, doesn't command." },
    { tier: 1, abbr: "OPA", full: "Organizational Process Assets", note: "Internal templates, processes, policies, historical info, lessons learned. An input to most processes." },
    { tier: 1, abbr: "EEF", full: "Enterprise Environmental Factors", note: "Conditions outside the team's control: culture, market, regulations, existing systems." },
    { tier: 1, abbr: "WBS", full: "Work Breakdown Structure", note: "Deliverable-oriented decomposition of 100% of the scope down to work packages." },
    { tier: 1, abbr: "RAM", full: "Responsibility Assignment Matrix", note: "Maps work to people. RACI is the most common form." },
    { tier: 1, abbr: "RACI", full: "Responsible, Accountable, Consulted, Informed", note: "Exactly ONE Accountable per activity. Clears ownership ambiguity." },
    { tier: 1, abbr: "PMO", full: "Project Management Office", note: "Supportive (advisory) · Controlling (compliance) · Directive (runs the projects)." },
    { tier: 1, abbr: "CCB", full: "Change Control Board", note: "Approves or rejects change requests in integrated change control." },
    { tier: 1, abbr: "CR", full: "Change Request", note: "Formal proposal to change a baseline. Goes through integrated change control — never just 'squeezed in.'" },
    { tier: 1, abbr: "SOW", full: "Statement of Work", note: "Describes the work/deliverables. Project SOW (internal) vs procurement SOW (to a seller)." },
    { tier: 1, abbr: "EVM", full: "Earned Value Management", note: "Integrates scope, schedule, and cost to measure performance objectively." },
    { tier: 1, abbr: "PV", full: "Planned Value", note: "Budgeted cost of work scheduled. (Watch out: PV also = Present Value in business cases.)" },
    { tier: 1, abbr: "EV", full: "Earned Value", note: "Budgeted value of the work actually done = % complete × BAC." },
    { tier: 1, abbr: "AC", full: "Actual Cost", note: "What you actually spent on the work performed." },
    { tier: 1, abbr: "BAC", full: "Budget at Completion", note: "The total approved baseline budget for the project." },
    { tier: 1, abbr: "CV", full: "Cost Variance", note: "CV = EV − AC. Negative = over budget." },
    { tier: 1, abbr: "SV", full: "Schedule Variance", note: "SV = EV − PV. Negative = behind schedule." },
    { tier: 1, abbr: "CPI", full: "Cost Performance Index", note: "CPI = EV / AC. Below 1 = over budget." },
    { tier: 1, abbr: "SPI", full: "Schedule Performance Index", note: "SPI = EV / PV. Below 1 = behind schedule." },
    { tier: 1, abbr: "EAC", full: "Estimate at Completion", note: "Forecast total cost. Typical: EAC = BAC / CPI." },
    { tier: 1, abbr: "ETC", full: "Estimate to Complete", note: "Remaining cost to finish = EAC − AC." },
    { tier: 1, abbr: "VAC", full: "Variance at Completion", note: "VAC = BAC − EAC. Negative = projected over budget." },
    { tier: 1, abbr: "TCPI", full: "To-Complete Performance Index", note: "Efficiency needed on remaining work = (BAC − EV) / (BAC − AC). >1 = harder than planned." },
    { tier: 1, abbr: "PO", full: "Product Owner", note: "Owns and prioritizes the product backlog; maximizes value (the 'what')." },
    { tier: 1, abbr: "SM", full: "Scrum Master", note: "Servant leader: removes impediments, coaches, facilitates. Not the team's boss." },
    { tier: 1, abbr: "DoD", full: "Definition of Done", note: "Shared quality checklist EVERY increment must meet to be 'done.'" },
    { tier: 1, abbr: "DoR", full: "Definition of Ready", note: "Entry criteria a backlog item must meet before a sprint pulls it in." },
    { tier: 1, abbr: "MVP", full: "Minimum Viable Product", note: "Smallest releasable version that delivers value and enables validated learning." },
    { tier: 1, abbr: "WIP", full: "Work in Progress", note: "Limiting WIP (Kanban) exposes bottlenecks and improves flow." },
    { tier: 1, abbr: "KPI", full: "Key Performance Indicator", note: "Metric used to gauge project/benefit performance against a target." },

    /* ---- Tier 2: high value ---- */
    { tier: 2, abbr: "CPM", full: "Critical Path Method", note: "Finds the longest path = shortest possible duration; its activities have zero float." },
    { tier: 2, abbr: "PERT", full: "Program Evaluation and Review Technique", note: "Three-point estimate (O + 4M + P) / 6, weighting Most Likely 4×." },
    { tier: 2, abbr: "EMV", full: "Expected Monetary Value", note: "Probability × Impact. Used in decision-tree analysis." },
    { tier: 2, abbr: "RBS", full: "Risk Breakdown Structure", note: "Hierarchy of risk categories. (Careful: RBS can also mean Resource Breakdown Structure.)" },
    { tier: 2, abbr: "CoQ", full: "Cost of Quality", note: "Conformance (prevention + appraisal) vs non-conformance (internal + external failure)." },
    { tier: 2, abbr: "QA", full: "Quality Assurance", note: "Manage Quality — audits and improves the PROCESS (doing it right)." },
    { tier: 2, abbr: "QC", full: "Quality Control", note: "Control Quality — inspects OUTPUTS for correctness. Comes before Validate Scope." },
    { tier: 2, abbr: "PDCA", full: "Plan-Do-Check-Act", note: "Deming/Shewhart cycle for continuous improvement (kaizen)." },
    { tier: 2, abbr: "RFP", full: "Request for Proposal", note: "Solicits a full solution/proposal for a complex need." },
    { tier: 2, abbr: "RFQ", full: "Request for Quotation", note: "Solicits a price quote for well-defined goods/services." },
    { tier: 2, abbr: "RFI", full: "Request for Information", note: "Gathers market information; not yet a bid." },
    { tier: 2, abbr: "IFB", full: "Invitation for Bid", note: "Requests a total price to do all the work; for well-defined scope." },
    { tier: 2, abbr: "FFP", full: "Firm Fixed Price", note: "Set price; SELLER carries the cost risk. Best for well-defined scope." },
    { tier: 2, abbr: "FPIF", full: "Fixed Price Incentive Fee", note: "Fixed price plus an incentive; introduces the Point of Total Assumption (PTA)." },
    { tier: 2, abbr: "CPFF", full: "Cost Plus Fixed Fee", note: "Costs reimbursed plus a fixed fee; BUYER carries more risk." },
    { tier: 2, abbr: "CPIF", full: "Cost Plus Incentive Fee", note: "Costs reimbursed plus a shared-savings incentive fee." },
    { tier: 2, abbr: "CPAF", full: "Cost Plus Award Fee", note: "Costs reimbursed plus an award fee at the buyer's subjective judgment." },
    { tier: 2, abbr: "T&M", full: "Time and Materials", note: "Hybrid contract for staff augmentation or small/undefined scope." },
    { tier: 2, abbr: "PTA", full: "Point of Total Assumption", note: "In FPIF, the cost above which the SELLER bears all further overrun." },
    { tier: 2, abbr: "RTM", full: "Requirements Traceability Matrix", note: "Links each requirement origin → design → build → test so nothing is lost." },
    { tier: 2, abbr: "NPV", full: "Net Present Value", note: "Discounted value of future cash flows. Pick the higher/positive NPV." },
    { tier: 2, abbr: "IRR", full: "Internal Rate of Return", note: "Discount rate where NPV = 0. Higher IRR = more attractive." },
    { tier: 2, abbr: "ROI", full: "Return on Investment", note: "(Benefit − Cost) / Cost. Higher is better." },
    { tier: 2, abbr: "BCR", full: "Benefit-Cost Ratio", note: "Benefits ÷ Costs. Greater than 1 is favorable." },
    { tier: 2, abbr: "SLA", full: "Service Level Agreement", note: "Agreed performance/service targets, often in contracts and with operations." },
    { tier: 2, abbr: "ADKAR", full: "Awareness, Desire, Knowledge, Ability, Reinforcement", note: "Prosci change-management model for moving people through change." },
    { tier: 2, abbr: "MoSCoW", full: "Must / Should / Could / Won't have", note: "Prioritization scheme the Product Owner uses to order value." },
    { tier: 2, abbr: "INVEST", full: "Independent, Negotiable, Valuable, Estimable, Small, Testable", note: "Checklist for a good user story." },
    { tier: 2, abbr: "PMIS", full: "Project Management Information System", note: "Tools/software (scheduling, EVM, comms) used to manage the project. An EEF." },

    /* ---- Tier 3: good to know ---- */
    { tier: 3, abbr: "CI/CD", full: "Continuous Integration / Continuous Delivery", note: "Integrate and auto-test frequently; release in small, safe increments." },
    { tier: 3, abbr: "TDD", full: "Test-Driven Development", note: "Write the test first, then the code to pass it. An XP practice." },
    { tier: 3, abbr: "XP", full: "Extreme Programming", note: "Agile method strong on engineering: pairing, TDD, refactoring, small releases." },
    { tier: 3, abbr: "SAFe", full: "Scaled Agile Framework", note: "Framework for applying agile across many teams." },
    { tier: 3, abbr: "LeSS", full: "Large-Scale Scrum", note: "Scrum scaled to multiple teams on one product." },
    { tier: 3, abbr: "CFD", full: "Cumulative Flow Diagram", note: "Shows work in each state over time; widening bands reveal bottlenecks (Kanban)." },
    { tier: 3, abbr: "FMEA", full: "Failure Mode and Effects Analysis", note: "Systematic technique to find and rank potential failure points." },
    { tier: 3, abbr: "SWOT", full: "Strengths, Weaknesses, Opportunities, Threats", note: "Analysis used in risk identification and strategy." },
    { tier: 3, abbr: "PESTLE", full: "Political, Economic, Social, Technological, Legal, Environmental", note: "Scans the external business environment for risks/factors." },
    { tier: 3, abbr: "VOC", full: "Voice of the Customer", note: "Capturing real customer needs to drive requirements/quality." },
    { tier: 3, abbr: "JIT", full: "Just in Time", note: "Lean idea: produce/deliver only as needed to cut waste and inventory." },
    { tier: 3, abbr: "LOE", full: "Level of Effort", note: "Support-type activity (no discrete deliverable) measured by time passing." },
    { tier: 3, abbr: "OBS", full: "Organizational Breakdown Structure", note: "Maps work packages to the org units responsible for them." },
    { tier: 3, abbr: "PDM", full: "Precedence Diagramming Method", note: "Builds the schedule network using nodes and FS/SS/FF/SF dependencies." },
    { tier: 3, abbr: "FS / SS / FF / SF", full: "Finish-to-Start / Start-to-Start / Finish-to-Finish / Start-to-Finish", note: "Logical relationships between activities. FS is by far the most common." },
    { tier: 3, abbr: "ES / EF / LS / LF", full: "Early Start / Early Finish / Late Start / Late Finish", note: "Network values from the forward pass (ES/EF) and backward pass (LS/LF)." },
    { tier: 3, abbr: "OKR", full: "Objectives and Key Results", note: "Goal-setting framework linking work to measurable outcomes." },
    { tier: 3, abbr: "BRD", full: "Business Requirements Document", note: "Captures the high-level business needs a solution must satisfy." }
  ],

  /* ---------------------------------------------------------------
     KEY TERMS / EASILY-CONFUSED PAIRS  {term, def, cat}
     These trap pairs win real exam points — know the distinction.
     --------------------------------------------------------------- */
  glossary: [
    { cat: "Quality", term: "Verification vs Validation", def: "Verification = built it RIGHT (internal check against the spec, e.g., Control Quality). Validation = built the RIGHT thing (the customer accepts it, e.g., Validate Scope). Verification comes first." },
    { cat: "Quality", term: "Validated vs Accepted deliverables", def: "Validated = checked internally for correctness in Control Quality. Accepted = formally signed off by the customer in Validate Scope. Validate first, then get acceptance." },
    { cat: "Quality", term: "Quality vs Grade", def: "Quality = conformance to requirements (low quality is never OK). Grade = category of features (a low-grade product can be perfectly acceptable if intended)." },
    { cat: "Quality", term: "Accuracy vs Precision", def: "Accuracy = how close to the true/target value. Precision = how tightly grouped repeated measurements are. You can be precise but inaccurate." },
    { cat: "Quality", term: "Prevention vs Inspection", def: "Prevention = keep errors out of the process (cheaper, preferred). Inspection = keep errors out of the customer's hands (catches them after the fact)." },
    { cat: "Quality", term: "QA vs QC", def: "Quality Assurance / Manage Quality = improve the PROCESS (audits, doing it right). Quality Control = inspect the OUTPUT for correctness." },
    { cat: "Quality", term: "Corrective vs Preventive action vs Defect repair", def: "Corrective = realign future performance after a deviation. Preventive = reduce probability of a future problem. Defect repair = fix something already defective." },
    { cat: "Risk", term: "Risk vs Issue", def: "Risk = an uncertain FUTURE event (risk register). Once it occurs it becomes an ISSUE you must manage now (issue log)." },
    { cat: "Risk", term: "Threat vs Opportunity", def: "Both are risks. Threat = negative uncertainty; Opportunity = positive uncertainty. Opportunities can be exploited, shared, or enhanced — not just avoided." },
    { cat: "Risk", term: "Secondary vs Residual risk", def: "Secondary = a NEW risk created BY your response. Residual = leftover risk that REMAINS after the response." },
    { cat: "Risk", term: "Qualitative vs Quantitative risk analysis", def: "Qualitative = subjective probability × impact ranking (always done). Quantitative = numeric modeling like Monte Carlo / EMV (only when warranted)." },
    { cat: "Risk", term: "Contingency vs Management reserve", def: "Contingency = for KNOWN risks, inside the cost baseline, PM controls it. Management reserve = for UNKNOWN risks, outside the baseline, needs management approval." },
    { cat: "Risk", term: "Risk appetite vs tolerance vs threshold", def: "Appetite = general willingness to take risk. Tolerance = measurable amount acceptable. Threshold = the specific trigger level where you act." },
    { cat: "Schedule", term: "Crashing vs Fast-tracking", def: "Crashing = add resources to critical activities (adds COST). Fast-tracking = run activities in parallel (adds RISK/rework). Both compress the schedule." },
    { cat: "Schedule", term: "Total float vs Free float", def: "Total float = how long an activity can slip without delaying the project END. Free float = without delaying the NEXT activity's early start." },
    { cat: "Schedule", term: "Lead vs Lag", def: "Lead = overlap that lets a successor start early (speeds up). Lag = an imposed delay between activities (e.g., concrete curing time)." },
    { cat: "Schedule", term: "Mandatory vs Discretionary dependency", def: "Mandatory (hard logic) = physically or contractually required. Discretionary (soft logic) = a preferred best practice that could be changed." },
    { cat: "Schedule", term: "Effort vs Duration vs Elapsed time", def: "Effort = labor (person-hours). Duration = working periods to finish. Elapsed time = calendar time including non-working days." },
    { cat: "Schedule", term: "Critical path vs Critical chain", def: "Critical path = longest path, zero float. Critical chain = critical path adjusted for resource limits, managed with buffers." },
    { cat: "Cost", term: "Sunk cost", def: "Money already spent and unrecoverable. IGNORE it in go-forward decisions — decide on future value only." },
    { cat: "Cost", term: "Opportunity cost", def: "The value of the next-best alternative you give up by choosing this project. Used when selecting among options." },
    { cat: "Cost", term: "Cost baseline vs Budget", def: "Cost baseline = time-phased spending plan incl. contingency (you measure against it). Total budget = cost baseline + management reserve." },
    { cat: "Estimating", term: "Analogous vs Parametric estimating", def: "Analogous = scale from a similar past project (fast, rough, top-down). Parametric = rate × quantity from a statistical relationship (more accurate)." },
    { cat: "Scope", term: "Scope creep vs Gold plating", def: "Scope creep = uncontrolled changes sneaking in. Gold plating = the team adding extras nobody asked for. Both are bad — route changes through change control." },
    { cat: "Scope", term: "Product scope vs Project scope", def: "Product scope = the features/functions of the result. Project scope = the work needed to deliver that product." },
    { cat: "Integration", term: "Data vs Information vs Reports", def: "Work performance DATA (raw, from executing) → INFORMATION (analyzed in monitoring & controlling) → REPORTS (packaged for stakeholders)." },
    { cat: "Integration", term: "Configuration vs Change management", def: "Configuration management controls the product's specs/versions. Change control governs approving/rejecting changes to the baselines." },
    { cat: "Stakeholders", term: "Stakeholder vs Shareholder", def: "Stakeholder = anyone who affects or is affected by the project (broad). Shareholder = an owner with equity (a narrow subset)." },
    { cat: "Agile", term: "Sprint Review vs Retrospective", def: "Review = demo the increment to stakeholders, inspect the PRODUCT. Retrospective = team-only, improve the PROCESS." },
    { cat: "Agile", term: "Product backlog vs Sprint backlog", def: "Product backlog = ordered list of everything, owned by the PO. Sprint backlog = the slice the team commits to this sprint, owned by the team." },
    { cat: "Agile", term: "Velocity vs Throughput", def: "Velocity = story points completed per sprint (Scrum forecasting). Throughput = items completed per period (Kanban flow metric)." },
    { cat: "Agile", term: "Lead time vs Cycle time", def: "Lead time = idea/request → delivery (the customer's view). Cycle time = active work start → finish (the team's view)." },
    { cat: "Agile", term: "Acceptance criteria vs Definition of Done", def: "Acceptance criteria = conditions for ONE specific story. Definition of Done = the team-wide quality bar applied to ALL work." },
    { cat: "Business", term: "Project vs Program vs Portfolio", def: "Project = one unique result. Program = related projects managed together for shared benefits. Portfolio = all work aligned to strategy." },
    { cat: "Business", term: "EEF vs OPA", def: "EEFs = conditions outside your control (culture, market, regulations). OPAs = internal assets you can use (templates, processes, lessons learned)." }
  ],
